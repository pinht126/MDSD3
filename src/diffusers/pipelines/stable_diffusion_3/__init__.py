...
try:
    ...
    _import_structure["pipeline_stable_diffusion_3"] = ["StableDiffusion3Pipeline", "StableDiffusion3MDPipeline"]
...
if TYPE_CHECKING or DIFFUSERS_SLOW_IMPORT:
    try:
        ...
        from .pipeline_stable_diffusion_3 import StableDiffusion3Pipeline, StableDiffusion3MDPipeline
